...
Actual data: http://python-data.dr-chuck.net/comments_350835.xml (Sum ends with 6)
...
def xml_parse_and_count(xml_url):
    ...
    uh = urllib.urlopen(xml_url)
    data = uh.read()
    #print 'Retrieved',len(data),'characters'
    #print data
    tree = ET.fromstring(data)
   
    #find all comments/comment
...
while True:        
    xml_url = raw_input("Enter in url:")
    if len(xml_url) < 1 : 
...
sum_of_comments = xml_parse_and_count(xml_url)
